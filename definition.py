...
class CompilationTarget:
    ...
    def __repr__(self):
        return f"<Target: illegal_dialects={list(self._illegal_dialects)}, illegal_ops={len(self._illegal_ops)}>"
...
class MLIRPass:
    ...
    def add_source(self, item: Union[str, Operation]):
        """定义该 Pass 能'消化'什么"""
    ...
    def add_target(self, item: Union[str, Operation]):
        """定义该 Pass 能'生产'什么"""
        if isinstance(item, str):
    ...
    def is_applicable(self, current_ops: Set[Operation]) -> bool:
        """
